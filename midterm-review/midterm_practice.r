...
m<-matrix(c(seq(10,120,by=10)),3,4,byrow=TRUE)
m
...
n<-cbind(c(1:10),letters[seq(1,10,by=1)],c(F,T))
n
...
set.seed(42)
nmat<-matrix(rnorm(10000,6,2),100,100)
nmat
########################################### SECOND PART
...
boxplot(rain$st050183,rain$st050263,rain$st050712,rain$st050843,rain$st050945,xlab="k",ymax=50)
...
plot(day$st050183[day$st050183>=2000&day$st050183<2001],rain$st050183[rain$st050183>=2000&rain$st050183<2001])
########################################### THIRD PART
...
plot(infants$gestation,infants$bwt,xlab="Gestation",ylab="Birthweight",main="Gestation Vs. Birthweight")
abline(fit,col="red")
