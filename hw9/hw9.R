...
cars<-cbind(mtcars,rownames(mtcars))
colnames(cars)[12]<-c("models")
...
Motion <- gvisMotionChart(WorldDat,xvar="life.expectancy",yvar="fertility.rate",timevar="year",
                          colorvar="region",sizevar="population",idvar="country")
